<?php
	...
	*/
	...
	try {
		...
		$dashboard = (new Applications\Standard\Application($main, 'Créer un compte'))
			->addLink(new Link(['rel' => 'stylesheet', 'type' => 'text/css', 'href' => \Mangrova::$resourcesPath . '/pages/createAccount/createAccount.css']))
			...
			->addScript(new Script(['type' => 'text/jsx', 'src' => \Mangrova::$resourcesPath . '/pages/createAccount/createAccount.js']))
			->run();
